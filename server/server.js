...
var server = http.createServer(function(request, response){
  ...
  if(path === '/index.html'){
    ...
    response.end()
  } else if(path === '/xiaoyang.js'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/javascript;charset=utf-8')
    response.write(fs.readFileSync('public/xiaoyang.js'))
    response.end()
  } else if(path === '/world.html'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/html;charset=utf-8')
    response.write(fs.readFileSync('public/world.html'))
    response.end()
    ...
    response.end()
  } else if(path === '/true.json'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/json;charset=utf-8')
    response.write(fs.readFileSync('public/true.json'))
    response.end()
  } else if(path === '/page2'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/json;charset=utf-8')
